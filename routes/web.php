...
Route::middleware('auth')->prefix('user')->group(function () {
    ...
    Route::post('/user/beneficiary/save', [UserDashboardController::class, 'save_beneficiary']);
});
...
Route::get('/create-beneficiary', function () {
    $benficiary = new BeneficiaryController();

    $saved = $benficiary->retrive(1);
