            ...
            <div class="p-2 mb-2 ">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h6 class="title" id="exampleModalLabel">Become A Vendor <em class="text-success">(Earn 50% of your referrals Upgrade.)</em></h6>
                    </div>
                    <div class="row card-body">
                        <div class="fee text-center mb-4">
                            <a href="/user/pay-vendor-fee" class="btn btn-primary">Pay Vendor Onetime Fee</a>
                            </div>
                        <div class="col-lg-8 mb-2 ">
                            <p class="h4">Who is a Vendor?</p>
                            <p>A vendor is an upgraded ODS user who gets discounts on product prices. As a vendor all ODS products will be discounted and you can resell to make some profit.</p>
