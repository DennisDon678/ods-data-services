    ...
    <div class="container">
        <div class="row gy-4 g-md-3 border-bottom pb-8 pb-lg-9 justify-content-center">
            ...
            <div class="col-6 col-md-3">
                ...
                <ul class="list-unstyled text-1100">
                    <li class="mb-1"> <a class="ls-1 lh-xl" href="/account-deletion-policy">Acc
                            Deletion Policy</a></li>
                    <li class="mb-1"> <a class="ls-1 lh-xl" href="/privacy-policy"> Privacy
                            Policy</a></li>
        ...
        <div class="row gy-2 py-3 justify-content-center justify-content-md-between">
            <div class="col-auto ps-0">
                <p class="text-center text-md-start lh-xl text-1100">{{env('APP_NAME')}} ©{{date('Y')}} <a class="fw-semi-bold"
                        href="https://www.linkedin.com/in/dennis-chiemezie-onah-7b3a90280/" target="_blank">by DONCODES </a>v1.0</p>
            </div>
