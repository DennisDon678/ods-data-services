                    ...
                    <div class="content">
                        ...
                        <div class="text-center">
                            ...
                            <p class="boxed-text-xl text-white pt-3 pb-3 font-15" id="msgcon">
                                Enter the email account associated with your account and we'll send you the reset
                                instructions!
                            </p>
                        </div>
                            ...
                            <div class="px-2">
                                ...
                                <div class="row pt-5 mb-3">
                                    <div class="col-12 text-center font-15">
                                        <a class="text-white" href="/auth/sign-in">Already Have An Account? Login
                                            Now</a>
                                    </div>
                                    <div class="col-12 text-center font-15 mt-2">
                                        <a class="text-white" href="/auth/sign-up">Don't Have An Account, Create
                                            Account</a>
                                    </div>
                                </div>
                            ...
                            <div class="px2">
                                <div class="input-style  no-borders has-icon mb-4">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password"
                                        placeholder="New Password" required="" readonly="">
                                ...
                                <div class="input-style  no-borders has-icon mb-4">
                                    ...
                                    <input type="password" class="form-control" id="password2" name="password2"
                                        placeholder="Retype Password" required="" readonly="">
                                ...
                                <button type="submit" id="submit-btn3" style="width: 100%;"
                                    class="btn btn-full btn-l font-600 font-15 gradient-highlight mt-4 rounded-s">
                                    Update Pasword
                                </button>
                                <div class="row pt-5 mb-3">
                                    <div class="col-12 text-center font-15">
                                        <a class="text-white" href="/auth/sign-in">Already Have An Account?
                                            Login</a>
                                    </div>
                                    <div class="col-12 text-center font-15 mt-2">
                                        <a class="text-white" href="/auth/sign-up">New User? Create
                                            Account</a>
                                    </div>
                                </div>
    ...
    <script>
        $("document").ready(function() {
            ...
            $('#emailCon').submit(function(e) {
                ...
                $.ajax({
                    url: '/auth/reset-password?get_user_code=true',
                    ...
                    success: function(resp) {
                        ...
                        if (resp == 0) {
                            swal('Alert!!',
                                "A Verification Code Have Been Sent To Your Email Address, Please Check And Provide The Code To Continue.",
                                "success");
                            $("#emailCon").hide();
                            $("#verCon").show();
                            ...
                            swal('Alert!!',
                                "Email Not Found, Please Verify Your Email And Try Again.",
                                "error");
                        } else {
                            swal('Alert!!', "Unknow Error, Please Contact Our Customer Support",
                                "error");
                        }
            ...
            $('#verCon').submit(function(e) {
                ...
                $.ajax({
                    url: '/auth/reset-password?verify_user_code=true',
                    data: new FormData($(this)[0]),
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(resp) {
                        ...
                        if (resp.code == 0) {
                            ...
                            swal('Alert!!',
                                "Incorrect or expired Code Provided, Please Verify Details And Try Again.",
                                "error");
                        } else {
                            swal('Alert!!', "Unknow Error, Please Contact Our Customer Support",
                                "error");
            ...
            $('#keyCon').submit(function(e) {
                ...
                $.ajax({
                    url: '/auth/reset-password?update_user_pass=true',
                    data: new FormData($(this)[0]),
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(resp) {
                        ...
                        if (resp == 0) {
                            swal('Alert!!',
                                "Password Updated Successfully, You Can Now Login With Your Details.",
                                "success");
                            $("#verCon").hide();
                            $("#keyCon").hide();
                            $("#emailCon").show();
                            ...
                            swal('Alert!!',
                                "Unknow Error, Please Contact Our Customer Support.",
                                "error");
                        }
