                                ...
                                <div id="nextregDiv" style="display:none;">
                                    <div class="input-style  no-borders has-icon mb-4">
                                        ...
                                        <select class="form-control" id="state" name="state" required="">
                                            ...
                                            <option value="Abuja FCT" style="color:#000000 !important;">Abuja FCT
                                            </option>
                                            ...
                                            <option value="Akwa Ibom" style="color:#000000 !important;">Akwa Ibom
                                            </option>
                                            ...
                                            <option value="Cross River" style="color:#000000 !important;">Cross River
                                            </option>
                                            ...
                                            <option value="Nassarawa" style="color:#000000 !important;">Nassarawa
                                            </option>
    ...
    <script type="text/javascript">
        $("document").ready(function() {
            ...
            $("#next-btn").click(function() {
                ...
                $('#next-btn').html(
                    '<i class="fa fa-spinner fa-spin" aria-hidden="true"></i> Validating ...');
